...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            ...
            echo '<script>window.location.href="edit_account.php";</script>';
        }
    }
}
                    ...
                    <div>
                        <form action="edit_account.php" method="post">
                            <div class="form-floating mb-3 mt-3">
                                <?php
                                echo sprintf('<input type="text" class="form-control" id="BreakfastShopID" placeholder="Enter email"
                                        name="username" value="%s"/>', $_SESSION["username"]);
                                ?>
...
<!--                                       name="username">-->
                            ...
                            <div class="form-floating mt-3 mb-3">
                                <input type="password" class="form-control" id="ShopName" placeholder="Enter password"
                                       name="password">
                                <label for="ShopName">新密碼</label>
                            </div>
                            <div>
                                <input type="submit" value="更改" name="submit" class="btn btn-primary">
